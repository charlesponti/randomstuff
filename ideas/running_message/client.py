...
def generate_metrics():
    running_metrics = [
        RunningMetrics(distance=0.14, heart_rate=176, time_stamp='2019-10-09T07:14:30.000z'),
        RunningMetrics(distance=0.20, heart_rate=186, time_stamp='2019-10-09T07:15:30.000z'),
        RunningMetrics(distance=0.23, heart_rate=183, time_stamp='2019-10-09T07:16:30.000z')
    ]
